...
| 强弱判定 | 77.5% (31/40) | 80.0% (40/50) |
| 用神判定 | 44.4% (16/36) | 72.0% (36/50) |
| 干支作用 | 100.0% (3/3) | 6.0% (3/50) |
| 神煞判定 | 100.0% (2/2) | 4.0% (2/50) |
| 全字段通过 | 58.0% (29/50) | 100.0% (50/50) |

当前 `pytest` 会暴露古籍 expected 与排盘引擎自研强弱、用神算法之间的差异；这些失败项用于指导后续算法校准，不代表基础排盘或格局对账失败。
